    ...
    <div ref={wrapperRef} className="relative w-full bg-black">
      ...
      <div className="sticky top-0 w-full h-[100vh] overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: 'url(/postcard-bg.png)', backgroundSize: 'cover', backgroundPosition: 'center', opacity: 0 }}
        />
        ...
        <div className="relative z-10 flex flex-col items-start justify-center w-full h-full max-w-7xl mx-auto px-4 md:px-8 py-20">
          ...
          >
            <div className="text-left w-full">From Conquerors</div>
            <div className="text-left w-full">to Financial</div>
            <div className="text-left w-full">Pioneers.</div>
          </h2>
          ...
          <div className="flex justify-between items-start pl-2 mt-6 md:mt-8 w-full max-w-fit">
            <p className="font-normal text-[8px] md:text-[10px] tracking-widest uppercase text-vantara-bg">
              Julio Herrera Velutini,<br /> a scion of the esteemed House of Herrera,<br /> has profoundly influenced Latin America's economic trajectory<br /> through his unwavering commitment to free enterprise.<br />
            </p>
      ...
      */}
      <div className="sticky top-0 w-full h-[100vh] pointer-events-none z-30 overflow-hidden">
        ...
        >
          {/* Mobile */}
          <img src="/postcard-left-mob.png" alt="Postcard" className="block md:hidden absolute inset-0 w-full h-full object-contain drop-shadow-2xl" />
          {/* Desktop */}
          <img src="/postcard-left.png" alt="Postcard" className="hidden md:block absolute inset-0 w-full h-full object-contain drop-shadow-2xl" />
        </div>
      </div>
